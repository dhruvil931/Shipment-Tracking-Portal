...
const stakeholders = [
  {
    ...
    items: [
      "Quickly find available carriers",
      "Compare transportation bids",
  ...
  },
  {
    ...
    items: [
      "Access new transport opportunities",
      "Bid for shipment loads",
      "Manage transport jobs efficiently",
    ],
  },
  {
    label: "CUSTOMER",
    ...
    items: [
      "Receive accurate shipment updates",
...
const steps = [
  {
    ...
    desc: "Enter your load details, weight, and destination in seconds.",
  },
  {
    number: "02",
    ...
    iconColor: "#2563eb",
    title: "Receive Bids",
    desc: "Verified carriers place competitive bids on your marketplace posting.",
  },
  {
    number: "03",
    ...
    desc: "Review ratings, history, and price to pick the best carrier.",
  },
  {
    number: "04",
    ...
    desc: "Watch your shipment move on the map until it reaches the door.",
  },
];
    ...
    <div className="bg-slate-100">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            ...
            <div className="w-full md:w-[58%] flex flex-col gap-5">
              ...
              <p className="dm-sans text-slate-500 text-[15px] leading-relaxed max-w-sm fade-3">
                Connecting shippers and carriers with maximum efficiency, full
                transparency, and advanced digital tools.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="dm-sans text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Experience a smarter logistics platform built for speed,
              transparency, and precise shipment visibility.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {featureCards.map((card, i) => (
              <div
                key={i}
                className="relative group p-8 bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-lg hover:-translate-y-2 transition-all duration-300"
              >
                {!card.gradient && (
                ...
                <div className="relative">
                  <div
                    className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-8 shadow-lg ${card.rotate} transition-transform ${card.gradient ? "bg-linear-to-tr from-blue-400 to-indigo-500" : "bg-blue-600"}`}
                  >
                    <i className={`${card.icon} text-white text-xl`} />
                  </div>
                  <h3 className="syne text-xl font-bold text-slate-900 mb-4">
                    {card.title}
                  </h3>
                  <p className="dm-sans text-slate-600 leading-relaxed">
                    {card.desc}
                  </p>
                </div>
              </div>
      ...
      <section className="bg-slate-100 relative overflow-hidden py-24 px-6">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <h2
            className="syne text-slate-900 font-extrabold tracking-tight mb-14"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {stakeholders.map((s, i) => (
              <div
                key={i}
                className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm transition-all duration-300 cursor-default hover:-translate-y-1 hover:bg-blue-50 hover:border-blue-200 hover:shadow-[0_12px_32px_rgba(37,99,235,0.12)]"
              >
                <div className="flex items-center gap-3 mb-6 pb-5 border-b border-slate-100">
                  ...
                  <span className="dm-sans text-slate-900 text-xs font-bold tracking-widest uppercase">
                    {s.label}
                  </span>
                </div>
                <div className="flex flex-col gap-3.5">
                  {s.items.map((item, j) => (
                    <div key={j} className="flex items-start gap-3">
                      <span className="dm-mono text-blue-600 text-[11px] font-bold tracking-wider pt-0.5 min-w-5">
                        0{j + 1}
                      </span>
                      <span className="dm-sans text-slate-500 text-sm leading-relaxed">
                        {item}
                      </span>
                    </div>
                  ))}
      ...
      <section className="bg-slate-100 py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10">
            <p className="dm-sans text-blue-600 text-xs font-semibold uppercase tracking-widest mb-2">
              How It Works
            </p>
            <h2
              className="syne text-slate-900 font-extrabold tracking-tight"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {steps.map((step, i) => (
              <div
                key={i}
                className="relative bg-white border border-slate-200 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-blue-100 overflow-hidden"
              >
                <span
                  className="dm-mono absolute top-3 right-4 font-bold select-none pointer-events-none"
                  style={{
                    fontSize: "3.5rem",
                    lineHeight: 1,
                    color: "#e2e8f0",
                ...
                <h3 className="syne text-slate-900 font-bold text-base mb-2">
                  {step.title}
                </h3>
                <p className="dm-sans text-slate-500 text-sm leading-relaxed">
                  {step.desc}
                </p>
              </div>
            ))}
